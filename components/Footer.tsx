        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-gray-300">
                <svg className="w-5 h-5 mt-0.5 shrink-0 text-jk-royal-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                <div>
                  <p className="hover:text-jk-royal-gold transition-colors">{tFooter('addressMain2')}</p>
                  <p className="text-xs text-gray-400">{tFooter('addressSub2')}</p>
                </div>
              </li>
              <li className="flex items-start gap-3 text-gray-300">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              <a href="https://www.facebook.com/p/Justine-kems-100051059601417/" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-jk-royal-gold hover:bg-jk-royal-gold hover:text-black transition-all">
