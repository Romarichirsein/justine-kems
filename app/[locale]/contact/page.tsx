...
export default function ContactPage() {
  ...
  return (
    <div className="bg-jk-cream dark:bg-jk-dark-bg min-h-screen pb-24">
      {/* Hero */}
      <section className="relative h-[50vh] flex items-center justify-center bg-jk-imperial-green overflow-hidden">
        ...
        <h1 className="relative z-10 text-6xl md:text-8xl font-script text-jk-royal-gold text-shadow-gold">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="bg-white dark:bg-jk-dark-surface p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <div>
                    <h3 className="font-bold text-lg dark:text-jk-cream">+237 677 463 484</h3>
                    <p className="text-sm text-jk-text-muted dark:text-gray-400">WhatsApp & appels — Lun-Sam</p>
                  </div>
                </div>
                <div className="flex gap-4 ml-16">
                  <a href="tel:+237677463484" className="text-jk-imperial-green dark:text-jk-royal-gold font-medium hover:underline text-sm">Appeler →</a>
              ...
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <div>
                     <h3 className="font-bold text-lg dark:text-jk-cream">En face du Marché Essos</h3>
                     <p className="text-sm text-jk-text-muted dark:text-gray-400">Quartier Essos, Yaoundé — Cameroun</p>
                  </div>
                </div>
                <div className="ml-16 border-l-2 border-jk-royal-gold pl-3 space-y-1">
                  <p className="text-xs text-jk-text-muted italic">Visible en bordure de route — stationnement possible à proximité</p>
                  <p className="text-xs text-jk-text-muted">À côté : Supermarché DOVV, Pharmacie du Marché Essos</p>
                </div>
              </div>

              {/* Horaires */}
              <div className="bg-gray-50 dark:bg-jk-dark-bg p-4 rounded-xl">
                 <h4 className="font-bold text-jk-imperial-green dark:text-jk-royal-gold mb-3 text-sm uppercase">Horaires d'ouverture</h4>
                 <table className="w-full text-sm text-jk-text-muted dark:text-gray-300">
                   <tbody>
                     <tr><td className="py-1">Lundi - Vendredi</td><td className="text-right font-medium">9h00 - 18h00</td></tr>
                     <tr><td className="py-1">Samedi</td><td className="text-right font-medium">10h00 - 16h00</td></tr>
                     <tr><td className="py-1 text-red-500">Dimanche</td><td className="text-right font-medium text-red-500">Fermé</td></tr>
                   </tbody>
                 </table>
                 <p className="text-xs text-jk-royal-gold font-semibold mt-3 border-t border-gray-200 dark:border-gray-700 pt-2">⚠️ Visites sur rendez-vous uniquement</p>
              </div>
          ...
          <div className="lg:col-span-8">
            <div className="bg-white dark:bg-jk-dark-surface p-8 md:p-12 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
              <h2 className="text-4xl font-display text-jk-imperial-green dark:text-jk-cream mb-8 border-b pb-4 dark:border-gray-700">Envoyez-nous un message</h2>
              
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium mb-2 dark:text-gray-300">Nom complet *</label>
                    <input {...register('name')} className="input-luxury" placeholder="Sarah M." />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium mb-2 dark:text-gray-300">Téléphone *</label>
                    <input {...register('phone')} className="input-luxury" placeholder="+237 6..." />
                    {errors.phone && <p className="text-red-500 text-xs mt-1 font-medium">{errors.phone.message}</p>}
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-2 dark:text-gray-300">Sujet *</label>
                    <select {...register('subject')} className="input-luxury">
                      <option value="">Sélectionnez un sujet</option>
                      <option value="Commande sur mesure">Commande sur mesure</option>
                      <option value="Location de tenue">Location de tenue</option>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    placeholder="Décrivez votre projet ou posez votre question (min 20 caractères)..."
                  />
                ...
                {/* Upload */}
                <div>
                  <label className="block text-sm font-medium mb-2 dark:text-gray-300">Photo ou modèle (Optionnel, Max 5MB)</label>
                  <div 
                    {...getRootProps()} 
                  ...
                  >
                    ...
                    {photo ? (
                      ...
                      <div className="text-jk-text-muted dark:text-gray-400">
                        ...
                        <p className="text-sm font-medium">Glissez une image ici ou cliquez pour explorer</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 mt-6">
                  ...
                  <label htmlFor="consent" className="text-sm text-jk-text-muted dark:text-gray-400">
                    J'accepte d'être contacté(e) par WhatsApp pour donner suite à cette demande.*
                  </label>
                </div>
      ...
      <section className="container mx-auto px-4 mt-16">
        <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700">
          <div className="bg-white dark:bg-jk-dark-surface px-8 py-5 flex items-center gap-3 border-b border-gray-100 dark:border-gray-700">
            ...
            <h3 className="font-bold text-jk-imperial-green dark:text-jk-cream text-lg">Notre emplacement — Marché Essos, Yaoundé</h3>
            <a
